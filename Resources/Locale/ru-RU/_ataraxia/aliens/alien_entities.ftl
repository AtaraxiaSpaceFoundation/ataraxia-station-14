ent-AlienEggGrowing = яйцо
    .desc = Большое инопланетное яйцо.
    .suffix = Растёт
...
ent-FacehuggerLamarr = Ламар
    .desc = На конце хвоста есть что-то вроде трубки, но не похоже, что он может ею пользоваться.
    .suffix = Лицехват

ent-MobAlienDrone = дрон
    .desc = Ксеноморф, да это реально.
ent-MobAlienSentinel = плевальщик
    .desc = { ent-MobAlienDrone.desc }
ent-MobAlienHunter = охотник
    .desc = { ent-MobAlienDrone.desc }
ent-MobAlienPraetorian = преторианец
    .desc = { ent-MobAlienDrone.desc }
ent-MobAlienQueen = королева
    .desc = { ent-MobAlienDrone.desc }
