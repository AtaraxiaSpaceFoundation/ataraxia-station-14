...
nuke-component-announcement-armed =  Внимание! Механизм самоуничтожения станции был активирован по координатам { $position }. До детонации { $time } секунд. Если запуск был произведен по ошибке - боеголовку можно обезвредить.
