ent-ImprovedCrowbar = улучшенный лом из латуни
    .desc = Инструмент, которому сложно найти замену.
    .suffix = { "" }

ent-ImprovedWrench = улучшенный гаечный ключ из латуни
    .desc = Символ инженерии, да еще и удобный, прямо у вас в руках!
    .suffix = { "" }

ent-ImprovedScrewdriver = улучшенная отвёртка из латуни
    .desc = Настоящий станок скручивания панелей в маленькой отвертке!
    .suffix = { "" }

ent-ImprovedWirecutter = улучшенные кусачки из латуни
    .desc = Перед этим оружием не устоит ни один провод, если вы не забыли желтую пару.
    .suffix = { "" }

ent-ImprovedWelder = улучшенный сварочный аппарат из латуни
