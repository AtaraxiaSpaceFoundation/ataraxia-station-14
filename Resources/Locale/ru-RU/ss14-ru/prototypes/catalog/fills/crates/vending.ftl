...
ent-CrateVendingMachineRestockRobustSoftdrinksFilled = ящик пополнения Напитков Робаст
    .desc = Содержит два набора пополнения торгоматов компании Напитки Робаст.
...
ent-CrateVendingMachineRestockSmokesFilled = ящик пополнения ШейдиСигс Делюкс
    .desc = Содержит два набора пополнения торгоматов ШейдиСигс Делюкс.
...
ent-CrateVendingMachineRestockGetmoreChocolateCorpFilled = ящик пополнения Гетмор Шоколад
    .desc = Содержит набор пополнения торгомата Гетмор Шоколад.
...
ent-CrateVendingMachineRestockDiscountDansFilled = ящик пополнения Дискаунт Дэн
    .desc = Содержит набор пополнения торгомата Дискаунт Дэн.
ent-CrateVendingMachineRestockDonutFilled = ящик пополнения Пончиков Монкис
    .desc = Содержит набор пополнения торгомата Пончики Монкис.
