...
ent-VendingMachineCigs = ШейдиСигс Делюкс
...
ent-VendingMachineShamblersJuice = торгомат Сок Шамблер
    .desc = ~Встряхните мне немного этого сока Шамблер!~
...
ent-VendingMachineSnackTeal = { ent-VendingMachineSnack }
    .suffix = Сине-зелёный
    .desc = { ent-VendingMachineSnack.desc }
ent-VendingMachineSnack = Гетмор Шоколад
...
ent-VendingMachineDonut = Пончики Монкис
    .desc = Автомат пончиков, предоставленный компанией Робаст Индастрис.
...
ent-VendingMachineHappyHonk = Хэппи Хонк
    .desc = Раздатчик коробок обедов Хэппи Хонк, разработаный компанией «Хонк! Ко.».
