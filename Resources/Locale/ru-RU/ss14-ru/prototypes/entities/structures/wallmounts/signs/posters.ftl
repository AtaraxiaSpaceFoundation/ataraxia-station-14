...
ent-PosterContrabandDonutCorp = Корпорация Пончиков
    .desc = Этот плакат является несанкционированной рекламой Корпорация Пончиков
...
ent-PosterContrabandDDayPromo = Реклама Д-Дня
...
ent-PosterContrabandWaffleCorp = Корпорация Вафель: Отличные винтовки, доступные цены
    .desc = Старая реклама винтовок от Корпорация Вафель 'Пушки лучше, цены ниже!'
