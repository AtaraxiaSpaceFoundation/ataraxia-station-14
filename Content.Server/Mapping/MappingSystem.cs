...
public sealed class MappingSystem : EntitySystem
{
    ...
    /// </summary>
    /// <returns></returns>
    private readonly Dictionary<MapId, (TimeSpan next, string fileName)> _currentlyAutosaving = new();
    ...
    public override void Update(float frameTime)
    {
        ...
        foreach (var (map, (time, name))in _currentlyAutosaving.ToArray())
        {
            ...
            var path = Path.Combine(saveDir, $"{DateTime.Now:yyyy-M-dd_HH.mm.ss}-AUTO.yml");
